...
class MLIRVisitor {
  public:
    ...
    void visitRegExp(mlir::Block *block, regexParser::RegExpContext *ctx, bool isFatherRoot);

    void visitConcatenation(regexParser::ConcatenationContext *ctx, bool isFatherRoot);
